...
<header>
    <nav>
        ...
        <ul class="sidenav">
            <li> <a href="/">Home</a> </li>
            <li> <a href="/about-us">Meet the papas</a> </li>
            <li> <a href="/what-to-do">What to do?</a> </li>
            <li> <a href="/arcade">Arcade games</a> </li>
            <li> <a href="/mindgame">Mind games</a> </li>
            <li> <a href="/education">Coding games</a> </li>
        </ul>
    </nav>

    <a href="/"><img class="logo-icon" src="/assets/images/icone/troll.png"></a>
