...
<body class="gameBackground">
    ...
    <main>
        ...
        <section  class="gamePage">
            ...
            <a href="/arcade/whack-a-mole" class="cartoucheAnchor" title="Go to our Whac-A-Mole game">
            ...
            <a href="/arcade/frenzy-clicker" class="cartoucheAnchor" title="Go to our click per seconds game">
                <section class="container gameCartouche">
            ...
            <a href="/arcade/flappy-bird" class="cartoucheAnchor" title="Go to our flappy bird game">
                <section class="container gameCartouche">
