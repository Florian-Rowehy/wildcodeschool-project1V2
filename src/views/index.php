...
<?php require __DIR__ . ('/components/_header.php') ?>
    ...
    <main class="index-background">
        ...
        <div class="articles">
            ...
            <a class="go_to_category categorie_cards" href="/arcade">
            ...
            <a class="go_to_category categorie_cards" href="/mindgame">
            ...
            <a class="go_to_category categorie_cards" href="/education">
